...
(function() {
  ...
  if (el) {
    try { var d = new Date('2026-03-04T06:38:41.151Z'); el.textContent = d.toLocaleString('en-US',{month:'2-digit',day:'2-digit',hour:'2-digit',minute:'2-digit',second:'2-digit'}) + ' ET'; }
